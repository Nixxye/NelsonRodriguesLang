...
%token <texto> FINALIZACAO FACA ENDIF ENQUANTO_COMECO ENQUANTO_FIM MAIOR MAIOR_IGUAL MENOR MENOR_IGUAL IGUAL NAO FOR ENTAO EU SE SAEM ENTRAM TODOS SOMAR SUBTRAIR DIVIDIR MULTIPLICAR
